...
export const metadata = {
  title: 'Cookiebeleid - Costel Banden',
  description: 'Cookiebeleid van Costel Banden - Vulcanizare mobilă Roeselare'
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">2. Welke cookies gebruiken wij?</h2>
              
              <h3 className="text-xl font-medium text-gray-700 mb-3">Essentiële Cookies (Altijd actief)</h3>
                ...
                <table className="w-full border-collapse border border-gray-300">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">Onthoudt uw cookiekeuze</td>
                      <td className="border border-gray-300 px-4 py-2">1 jaar</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">PHPSESSID</td>
                      <td className="border border-gray-300 px-4 py-2">Website functionaliteit</td>
                      <td className="border border-gray-300 px-4 py-2">Tot sessie eindigt</td>
                    </tr>
                  </tbody>
                </table>
              </div>

              <h3 className="text-xl font-medium text-gray-700 mb-3">Analytische Cookies (Met toestemming)</h3>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">Google Search Console</td>
                      <td className="border border-gray-300 px-4 py-2">Diverse Google cookies</td>
                      <td className="border border-gray-300 px-4 py-2">Website prestaties meten</td>
                      <td className="border border-gray-300 px-4 py-2">26 maanden</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">3. Waarom gebruiken wij cookies?</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">4. Uw cookiekeuzes</h2>
              
              <h3 className="text-xl font-medium text-gray-700 mb-3">Toestemming beheren</h3>
              <p className="mb-3">U kunt uw cookievoorkeuren altijd wijzigen:</p>
              ...
              <h3 className="text-xl font-medium text-gray-700 mb-3">Browser instellingen</h3>
              <p className="mb-3">U kunt cookies ook beheren via uw browser:</p>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              ...
              <p className="mb-3">Wij gebruiken alleen cookies van:</p>
              <ul className="list-disc list-inside space-y-2 mb-4">
                <li><strong>Google LLC:</strong> Voor Search Console statistieken</li>
              </ul>

              <p className="mb-3">Deze bedrijven hebben hun eigen privacybeleid:</p>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">6. Updates van dit beleid</h2>
              <p>Wij kunnen dit cookiebeleid wijzigen. Controleer deze pagina regelmatig voor updates.</p>
            </section>
